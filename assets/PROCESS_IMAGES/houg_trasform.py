...
if __name__ == '__main__':
    ...
    import imutils
    cv2.imshow("Original", imutils.resize(result, height=650))
    cv2.imshow("Scanned", imutils.resize(result_norm, height=650))
    cv2.waitKey(0)
    ...
    text = pytesseract.image_to_string(result_norm, lang='eng+fra', config=config)
    print('text 3 \n\n ', text)
    image=result_norm
